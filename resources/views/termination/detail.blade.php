                        ...
                        <div class="card-body box-profile">
                            <div class="text-center">
                                <img class="profile-user-img img-fluid img-circle"
                                    src="{{ asset('assets/dist/img/avatar6.png') }}" alt="User profile picture">
                            </div>
                ...
                <div class="col-md-9">
                    <div class="card card-gray" id="personal">
                        ...
                        <div class="card-body">
                            <dl class="row">
                                ...
                                <dd class="col-sm-9">{{ $employee->emp_pob ?? '-' }},
                                    {{ date('d-M-Y', strtotime($employee->emp_dob)) ?? '-' }}</dd>
                        ...
                        <div class="card-footer">
                            <div class="col-12 text-right">
                                <a class="btn btn-sm btn-icon btn-primary" data-toggle="modal"
                    ...
                    <div class="card card-gray" id="banks">
                        ...
                        <div class="card-footer">
                            <div class="col-12 text-right">
                                <a class="btn btn-sm btn-icon btn-primary" data-toggle="modal"
                                    data-target="#modal-bank-{{ $bank->id }}"><i class="fas fa-pen-square"></i></a>
                            </div>
                        </div>
                        <!-- /.card-body -->
                    </div>
                    <div class="card card-gray" id="insurances">
                            ...
                            <table class="table table-hover table-head-fixed text-nowrap">
                                ...
                                <tbody>
                                    @if ($insurances->isEmpty())
                                        <tr>
                                            <td colspan="5" class="text-center"><span class="badge bg-warning">No Data
                                                    Available</span></td>
                                        </tr>
                                    @else
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form
                                                        ...
                                                        @method('delete')
                                                        @csrf
                                                        <button class="btn btn-sm btn-icon btn-danger"><i
                        ...
                        <div class="card-footer">
                            <div class="col-12 text-right">
                                <a class="btn btn-sm btn-icon btn-warning" data-toggle="modal"
                                    data-target="#modal-insurance" title="Add Insurance"><i class="fas fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="card card-gray" id="families">
                        ...
                        <div class="card-body table-responsive p-0" style="height: 200px;">
                            <table class="table table-hover table-head-fixed text-nowrap">
                                ...
                                <tbody>
                                    @if ($families->isEmpty())
                                        <tr>
                                            <td colspan="6" class="text-center"><span class="badge bg-warning">No Data
                                                    Available</span></td>
                                        </tr>
                                    @else
                                                ...
                                                <td>
                                                    <a class="btn btn-sm btn-icon btn-primary" data-toggle="modal"
                                                        data-target="#modal-family-{{ $family->id }}"><i
                                                            class="fas fa-pen-square"></i></a>
                                                    <form action="{{ url('families/' . $employee->id . '/' . $family->id) }}"
                                                        method="post"
                                                        onsubmit="return confirm('Are you sure want to delete this data?')"
                                                        class="d-inline">
                                                        @method('delete')
                        ...
                        <div class="card-footer">
                            <div class="col-12 text-right">
                                <a class="btn btn-sm btn-icon btn-warning" data-toggle="modal"
                                    data-target="#modal-family" title="Add Family"><i class="fas fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="card card-gray" id="educations">
                                                ...
                                                <td>
                                                    <a class="btn btn-sm btn-icon btn-primary" data-toggle="modal"
                                                        data-target="#modal-education-{{ $education->id }}"><i
                                                            class="fas fa-pen-square"></i></a>
                                                    <form action="{{ url('schools/' . $employee->id . '/' . $education->id) }}"
                                                        method="post"
                                                        onsubmit="return confirm('Are you sure want to delete this data?')"
                                                        class="d-inline">
                                                        @method('delete')
                        ...
                        <div class="card-footer">
                            <div class="col-12 text-right">
                                <a class="btn btn-sm btn-icon btn-warning" data-toggle="modal"
                                    data-target="#modal-education" title="Add Education"><i class="fas fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="card card-gray" id="courses">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-sm btn-icon btn-primary"
                                                        href="{{ url('courses/' . $course->id . '/edit') }}"
                                                        data-toggle="modal"
                                                        data-target="#modal-course-{{ $course->id }}"><i
                                                            class="fas fa-pen-square"></i></a>
                                                    <form action="{{ url('courses/' . $employee->id . '/' . $course->id) }}"
                                                        method="post"
                                                        onsubmit="return confirm('Are you sure want to delete this data?')"
                                                        class="d-inline">
                                                        @method('delete')
                        ...
                        <div class="card-footer">
                            <div class="col-12 text-right">
                                <a class="btn btn-sm btn-icon btn-warning" data-toggle="modal"
                                    data-target="#modal-course" title="Add Course"><i class="fas fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="card card-gray" id="jobs">
                                    ...
                                    @else
                                        @foreach ($jobs as $job)
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-sm btn-icon btn-primary"
                                                        href="{{ url('jobexperiences/' . $job->id . '/edit') }}"
                                                        data-toggle="modal"
                        ...
                        <div class="card-footer">
                            <div class="col-12 text-right">
                                <a class="btn btn-sm btn-icon btn-warning" data-toggle="modal" data-target="#modal-job"
                                    title="Add Job Experience"><i class="fas fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="card card-gray" id="units">
                        ...
                        <div class="card-body table-responsive p-0" style="height: 200px;">
                            <table class="table table-hover table-head-fixed text-nowrap">
                                ...
                                <tbody>
                                    @if ($units->isEmpty())
                                        <tr>
                                            <td colspan="4" class="text-center"><span class="badge bg-warning">No Data
                                                    Available</span></td>
                                        </tr>
                                    @else
                        ...
                        <div class="card-footer">
                            <div class="col-12 text-right">
                                <a class="btn btn-sm btn-icon btn-warning" data-toggle="modal" data-target="#modal-unit"
                                    title="Add Operable Unit"><i class="fas fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="card card-gray" id="licenses">
                                    ...
                                    @else
                                        @foreach ($licenses as $license)
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-sm btn-icon btn-primary"
                                                        href="{{ url('licenses/' . $license->id . '/edit') }}"
                                                        data-toggle="modal"
                                                        data-target="#modal-license-{{ $license->id }}"><i
                                                            class="fas fa-pen-square"></i></a>
                                                    <form action="{{ url('licenses/' . $employee->id . '/' . $license->id) }}"
                                                        method="post"
                                                        onsubmit="return confirm('Are you sure want to delete this data?')"
                                                        class="d-inline">
                                                        @method('delete')
                        ...
                        <div class="card-footer">
                            <div class="col-12 text-right">
                                <a class="btn btn-sm btn-icon btn-warning" data-toggle="modal"
                                    data-target="#modal-license" title="Add License"><i class="fas fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="table table-hover table-head-fixed text-nowrap">
                                ...
                                <tbody>
                                    @if ($administrations->isEmpty())
                                        <tr>
                                            <td colspan="8" class="text-center"><span class="badge bg-warning">No Data
                                                    Available</span></td>
                                        </tr>
                                    @else
                                    ...
                                    <div class="col-6">
                                        <div class="row">
                                            <form class="form-horizontal"
                                                action="{{ url('employees/addImages/' . $employee->id) }}" method="POST"
                                    ...
                                    <div class="col-sm-2 text-center">
                                        <a href="{{ asset('images/' . $image->employee_id . '/' . $image->filename) }}"
                                            ...
                                            <img src="{{ asset('images/' . $image->employee_id . '/' . $image->filename) }}"
                                                class="img-fluid mb-2" alt="{{ $image->filename }}" />
                                        </a>
                                        <a href="{{ url('employees/deleteImage/' . $image->id) }}"
                ...
                $(document).ready(function() {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            console.log(data.department_name);
                            // set value to department the data
                            $('.department{{ $administration->id }}').val(data
                                .department_name);
                        }
                    });
                });
