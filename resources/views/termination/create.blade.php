                ...
                <div class="card-tools">
                  <ul class="nav nav-pills ml-auto">
                    <li class="nav-item mr-2">
                      ...
                      <a href="{{ url('terminations') }}" class="btn btn-warning"><i class="fas fa-undo"></i>
                        Back</a>
                    </li>
                  </ul>
                </div>
                  ...
                  <div class="row">
                    <div class="col-12 mb-3">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="date" class="form-control @error('termination_date') is-invalid @enderror" name="termination_date" value="{{ old('termination_date') }}">
