<a class="btn btn-icon btn-primary btn-xs" href="{{ url('employeebanks/' . $employeebanks->id . '/show') }}" data-toggle="modal" data-target="#modal-lg-{{ $employeebanks->id }}"><i class="fas fa fa-eye"></i></a>
