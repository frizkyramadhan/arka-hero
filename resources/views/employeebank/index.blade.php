        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Employee Bank Data Table</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4">
                ...
                <div class="col-sm-12 col-md-6">
                  ...
                  <div class="col-sm-12 col-md-6">
                    <div class="mt-5 d-flex justify-content-end">
                      <a href="{{route('AddEmployeebank')}}" class="btn btn-primary btn-sm">Add Data</a>
                  </div>
                  </div>
                </div>
                <div class="my-3">
                ...
                <tr role="row">
                  ...
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Bank Name</th>              
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Bank Account No</th>              
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Bank Account Name</th>              
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Bank Account Branch</th>              
                ...
                <tbody>
                  @foreach ($employeebanks as $item)
                    <tr class="odd">
                      ...
                      <td class="sorting_1">{{ $item->banks->bank_name }}</td>
                      <td class="sorting_1">{{ $item->bank_account_no }}</td>
                      <td class="sorting_1">{{ $item->bank_account_name }}</td>
                      <td class="sorting_1">{{ $item->bank_account_branch }}</td>
                      <td class="text-center">
                        ...
                        <form action="deleteEmployeebank/{{$item->slug}}" method="post"
                          ...
                          <a href="editEmployeebank/{{$item->slug}}" class="btn btn-primary btn-sm">
