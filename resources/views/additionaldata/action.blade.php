<a class="btn btn-icon btn-primary" href="{{ url('additionaldatas/' . $additionaldatas->id . '/show') }}" data-toggle="modal" data-target="#modal-lg-{{ $additionaldatas->id }}"><i class="fas fa-pen-square"></i></a>
