        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Driver License Data Table</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4">
                ...
                <div class="col-sm-12 col-md-6">
                  ...
                  <div class="col-sm-12 col-md-6">
                    <div class="mt-5 d-flex justify-content-end">
                      <a href="{{route('addLicense')}}" class="btn btn-primary btn-sm">Add Data</a>
                  </div>
                  </div>
                </div>
                <div class="my-3">
                ...
                <tr role="row">
                  ...
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Driver License No</th>              
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Driver License Type</th>              
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Driver License Exp</th>              
                ...
                <tbody>
                  @foreach ($licenses as $item)
                    <tr class="odd">
                      ...
                      <td class="sorting_1">{{ $item->driver_license_no }}</td>
                      <td class="sorting_1">{{ $item->driver_license_type }}</td>
                      <td class="sorting_1">{{ $item->driver_license_exp }}</td>
                      <td class="text-center">
                        ...
                        <form action="deleteLicense/{{$item->slug}}" method="post"
                          ...
                          <a href="editLicense/{{$item->slug}}" class="btn btn-primary btn-sm">
