        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a class="small-box-footer" data-toggle="modal" data-target="#modal-lg1">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a class="small-box-footer" data-toggle="modal" data-target="#modal-lg2">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-secondary">
              ...
              <a class="small-box-footer" data-toggle="modal" data-target="#modal-lg5">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <div class="col-lg-3 col-6">
            <!-- small box -->
            <div class="small-box bg-gradient">
              ...
              <a class="small-box-footer" data-toggle="modal" data-target="#modal-lg6">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <div class="col-lg-3 col-6">
            <!-- small box -->
            <div class="small-box bg-dark">
              ...
              <a class="small-box-footer" data-toggle="modal" data-target="#modal-lg7">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <div class="col-lg-3 col-6">
            <!-- small box -->
            <div class="small-box bg-info">
              ...
              <a class="small-box-footer" data-toggle="modal" data-target="#modal-lg8">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <div class="col-lg-3 col-6">
            <!-- small box -->
            <div class="small-box bg-danger">
              ...
              <a class="small-box-footer" data-toggle="modal" data-target="#modal-lg9">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
      ...
      <div class="modal fade" id="modal-lg2">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table id="example2" width="100%" class="table table-sm table-bordered table-striped">
                  <thead>
                    <tr>
                      <th class="text-center">No</th>
                      <th>NIK</th>
      ...
      <div class="modal fade" id="modal-lg3">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table id="example3" width="100%" class="table table-sm table-bordered table-striped">
                  <thead>
                    <tr>
                      <th class="text-center">No</th>
                      <th>NIK</th>
      ...
      <div class="modal fade" id="modal-lg4">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table id="example4" width="100%" class="table table-sm table-bordered table-striped">
                  <thead>
                    <tr>
                      <th class="text-center">No</th>
                      <th>NIK</th>
      ...
      <div class="modal fade" id="modal-lg5">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table id="example5" width="100%" class="table table-sm table-bordered table-striped">
                  <thead>
                    <tr>
                      <th class="text-center">No</th>
                      <th>NIK</th>
      ...
      <div class="modal fade" id="modal-lg6">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table id="example6" width="100%" class="table table-sm table-bordered table-striped">
                  <thead>
                    <tr>
                      <th class="text-center">No</th>
                      <th>NIK</th>
      ...
      <div class="modal fade" id="modal-lg7">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table id="example7" width="100%" class="table table-sm table-bordered table-striped">
                  <thead>
                    <tr>
                      <th class="text-center">No</th>
                      <th>NIK</th>
      ...
      <div class="modal fade" id="modal-lg8">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table id="example8" width="100%" class="table table-sm table-bordered table-striped">
                  <thead>
                    <tr>
                      <th class="text-center">No</th>
                      <th>NIK</th>
      ...
      <div class="modal fade" id="modal-lg9">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table id="example9" width="100%" class="table table-sm table-bordered table-striped">
                  <thead>
                    <tr>
                      <th class="text-center">No</th>
                      <th>Full Name</th>
      ...
      <div class="modal fade" id="modal-lg10">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table id="example10" width="100%" class="table table-sm table-bordered table-striped">
                  <thead>
                    <tr>
                      <th class="text-center">No</th>
                      <th>NIK</th>
