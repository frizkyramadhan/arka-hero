                                ...
                                <form class="form-horizontal" action="{{ route('addProjects') }}" method="post">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" value="{{ old('project_code') }}" name="project_code"
                                                    class="form-control" id="project_code" placeholder="Project Code">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="project_name" class="col-sm-2 col-form-label">Project Name</label> :
                                            <div class="col-sm-3">
                                                <input type="text" value="{{ old('project_name') }}" name="project_name"
                                        ...
                                        <div class="form-group row">
                                            <label for="project_location" class="col-sm-2 col-form-label">Project
                                                Location</label> :
                                            <div class="col-sm-3">
                                                <input type="text" value="{{ old('project_location') }}"
                                                    name="project_location" class="form-control" id="project_location"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" value="{{ old('bowheer') }}" name="bowheer"
                                                    class="form-control" id="bowheer" placeholder="Bowheer">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-3">
                                                <select name="leave_type" class="form-control" id="leave_type" required>
                                                    ...
                                                    <option value="non_roster"
                                                        {{ old('leave_type') == 'non_roster' ? 'selected' : '' }}>Non-Roster
                                                    </option>
                                                    <option value="roster"
                                                        {{ old('leave_type') == 'roster' ? 'selected' : '' }}>Roster
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-3">
                                                <select name="project_status" class="form-control" id="project_status"
                                                    ...
                                                    <option value="1"
                                                        {{ old('project_status') == '1' ? 'selected' : '' }}>Active</option>
                                                    <option value="0"
                                                        {{ old('project_status') == '0' ? 'selected' : '' }}>Inactive
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
