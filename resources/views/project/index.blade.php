                            ...
                            <div class="card-body">
                                <div class="tab-content p-0">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text"
                                                ...
                                                name="project_location" value="{{ old('project_location') }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text"
                                                class="form-control @error('bowheer') is-invalid @enderror" name="bowheer"
                                                value="{{ old('bowheer') }}" placeholder="Bowheer" required>
                                            @error('bowheer')
                                                <div class="error invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-sm-10">
                                            <select name="leave_type"
                                                ...
                                                <option value="non_roster"
                                                    {{ old('leave_type') == 'non_roster' ? 'selected' : '' }}>
                                                    Non-Roster</option>
                                                <option value="roster"
                                                    {{ old('leave_type') == 'roster' ? 'selected' : '' }}>Roster</option>
                                            </select>
                                            @error('leave_type')
