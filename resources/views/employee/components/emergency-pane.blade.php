...
<div id="emergency-pane" class="content" role="tabpanel" aria-labelledby="emergency-pane-trigger">
    <div class="d-flex justify-content-between align-items-center mb-3 border-bottom pb-2">
        <h5 class="mb-0">Emergency Calls</h5>
        <div>
            <button class="btn btn-primary" data-toggle="modal" data-target="#modal-emergency" title="Add Emergency Call">
                ...
                @forelse ($emergencies as $emergency)
                    <tr>
                        ...
                        <td class="action-buttons">
                            ...
                            <form action="{{ url('emrgcalls/' . $employee->id . '/' . $emergency->id) }}" method="post"
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const emergencyPane = document.getElementById('emergency-pane');
        const emergencyTrigger = document.getElementById('emergency-pane-trigger');
        ...
        if (emergencyTrigger) {
            emergencyTrigger.addEventListener('click', function() {
                ...
                emergencyPane.appendChild(overlay);

                // Simulate loading delay (remove this in production)
                setTimeout(() => {
                    // Remove loading overlay
                    emergencyPane.removeChild(overlay);
                    // Show content
                    emergencyPane.classList.add('loaded');
                }, 500);
            });
        }
    });
