                ...
                <div class="modal-body">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('course_address') is-invalid @enderror"
                                    name="course_address" value="{{ old('course_address') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('course_year') is-invalid @enderror"
                                    name="course_year" value="{{ old('course_year') }}">
                                @error('course_year')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('course_remarks') is-invalid @enderror"
                                    name="course_remarks" value="{{ old('course_remarks') }}">
                    ...
                    <div class="modal-body">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text"
                                        class="form-control @error('course_address') is-invalid @enderror"
                                        name="course_address"
                                        value="{{ old('course_address', $course->course_address) }}">
                                    @error('course_address')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text"
                                        ...
                                        name="course_year" value="{{ old('course_year', $course->course_year) }}">
                                    @error('course_year')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text"
                                        class="form-control @error('course_remarks') is-invalid @enderror"
                                        name="course_remarks"
                                        value="{{ old('course_remarks', $course->course_remarks) }}">
                                    @error('course_remarks')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
