    ...
    <div class="modal-content">
      ...
      <form action="{{ url('terminations') }}" method="POST">
        ...
        <div class="modal-body">
          <div class="card-body">
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="date" class="form-control @error('termination_date') is-invalid @enderror" name="termination_date" value="{{ old('termination_date', $employee->termination_date) }}">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <select name="termination_reason" class="form-control" style="width: 100%;">
                  ...
                  <option value="Termination" {{ old('termination_reason') == 'Termination' ? 'selected' : '' }}>Termination</option>
                </select>
            ...
            <div class="form-group row align-items-center">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control @error('coe_no') is-invalid @enderror" name="coe_no" value="{{ old('coe_no', $employee->coe_no) }}">
                @error('coe_no')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
        ...
        <div class="modal-footer justify-content-between">
          ...
          <button type="submit" class="btn btn-danger" onclick="return confirm('Are you sure to terminate this employee?')">Terminate</button>
        </div>
      </form>
    </div>
  </div>
