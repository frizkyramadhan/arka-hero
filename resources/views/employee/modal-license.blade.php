<div class="modal fade text-left" id="modal-license">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form action="{{ url('licenses/'.$employee->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          <div class="card-body">
            ...
            <div class="form-group row">
              <label class="col-sm-2 col-form-label">Dokumen SIM</label>
              <div class="col-sm-10">
                <input type="file" name="supporting_document" class="form-control-file" accept=".pdf,image/*">
...
<div class="modal fade text-left" id="modal-license-{{ $license->id }}">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form action="{{ url('licenses/' . $license->id) }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="card-body">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                ...
                <small class="form-text d-block"><a href="{{ route('licenses.download-document', $license) }}"
