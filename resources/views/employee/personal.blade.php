                    ...
                    <div class="row form-group">
                      ...
                      <div class="col-3">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="emp_pob" id="emp_pob" value="{{ request('emp_pob') }}">
                        </div>
                      </div>
                      <div class="col-3">
                        <div class="form-group">
                          <label class="form-control-label">Religion</label>
                          <select name="religion_name" class="form-control select2bs4" id="religion_name" style="width: 100%;">
                            <option value="">- All -</option>
                            @foreach ($religions as $religion => $data)
                            <option value="{{ $data->religion_name }}" {{ request('religion_name') == $data->religion_name ? 'selected' : '' }}>
                              {{ $data->religion_name }}
                            </option>
                            @endforeach
                          </select>
                      ...
                      <div class="col-3">
                        <div class="form-group">
                          ...
                          <select name="gender" class="form-control select2bs4" id="gender" style="width: 100%;">
                            <option value="">- All -</option>
                      ...
                      <div class="col-3">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="marital" id="marital" value="{{ request('marital') }}">
                        </div>
                      </div>
                      <div class="col-3">
                        <div class="form-group">
                          <label class="form-control-label">Address</label>
                          <input type="text" class="form-control" name="address" id="address" value="{{ request('address') }}" placeholder="Jalan">
                        </div>
                      </div>
                      <div class="col-3">
                        <div class="form-group">
                          <label class="form-control-label">Village</label>
                          <input type="text" class="form-control" name="village" id="village" value="{{ request('village') }}" placeholder="Desa/Dusun">
                        </div>
                      </div>
                      <div class="col-3">
                        <div class="form-group">
                          <label class="form-control-label">Ward</label>
                          <input type="text" class="form-control" name="ward" id="ward" value="{{ request('ward') }}" placeholder="Kelurahan">
                        </div>
                      </div>
                      <div class="col-3">
                        <div class="form-group">
                          <label class="form-control-label">District</label>
                          <input type="text" class="form-control" name="district" id="district" value="{{ request('district') }}" placeholder="Kecamatan">
                        </div>
                      </div>
                      <div class="col-3">
                        <div class="form-group">
                          <label class="form-control-label">City</label>
                          <input type="text" class="form-control" name="city" id="city" value="{{ request('city') }}" placeholder="Kota/Kabupaten">
                        </div>
                      </div>
                      <div class="col-3">
                        <div class="form-group">
...
<script>
  $(function() {
    var table = $("#example1").DataTable({
      ...
      , ajax: {
        ...
        , data: function(d) {
          d.date1 = $('#date1').val()
            ...
            , d.emp_pob = $('#emp_pob').val()
            , d.religion_name = $('#religion_name').val()
            , d.gender = $('#gender').val()
            , d.marital = $('#marital').val()
      ...
      , fixedColumns: true
    , })
    $('#date1, #date2, #fullname, #emp_pob, #emp_dob, #religion_name, #gender, #marital, #address, #village, #ward, #district, #city, #phone').keyup(function() {
      table.draw();
    });
    ...
    $('#btn-reset').click(function() {
      $('#date1, #date2, #fullname, #emp_pob, #emp_dob, #religion_name, #gender, #marital, #address, #village, #ward, #district, #city, #phone').val('');
