<div class="btn-group">
    <a title="Detail" class="btn btn-sm btn-icon btn-success" href="{{ url('employees/' . $model->id) }}"><i
    ...
    @hasrole('administrator')
        ...
        <div class="dropdown-menu" role="menu">
            <form action="{{ url('employees/' . $model->id) }}" method="post"
                onsubmit="return confirm('This employee and all his/her data will be deleted. Are you sure?')"
                class="d-inline">
                @method('delete')
                @csrf
