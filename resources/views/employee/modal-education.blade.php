                ...
                <div class="modal-body">
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('education_name') is-invalid @enderror"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text"
                                    class="form-control @error('education_address') is-invalid @enderror"
                                    name="education_address" value="{{ old('education_address') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('education_year') is-invalid @enderror"
                                    name="education_year" value="{{ old('education_year') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text"
                                    class="form-control @error('education_remarks') is-invalid @enderror"
                                    name="education_remarks" value="{{ old('education_remarks') }}">
                    ...
                    <div class="modal-body">
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text"
                                        ...
                                        name="education_name"
                                        value="{{ old('education_name', $education->education_name) }}">
                                    @error('education_name')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text"
                                        ...
                                        value="{{ old('education_address', $education->education_address) }}">
                                    @error('education_address')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text"
                                        class="form-control @error('education_year') is-invalid @enderror"
                                        name="education_year"
                                        value="{{ old('education_year', $education->education_year) }}">
                                    @error('education_year')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text"
                                        ...
                                        value="{{ old('education_remarks', $education->education_remarks) }}">
                                    @error('education_remarks')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
