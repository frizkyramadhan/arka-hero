@if ($additional == null)
<div class="modal fade text-left" id="modal-additional">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Edit Employee - Add Additional Data</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="{{ url('additionaldatas') }}" method="POST">
        ...
        <div class="modal-body">
          <div class="card-body">
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control @error('cloth_size') is-invalid @enderror" name="cloth_size" value="{{ old('cloth_size') }}">
                @error('cloth_size')
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control @error('pants_size') is-invalid @enderror" name="pants_size" value="{{ old('pants_size') }}">
                @error('pants_size')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control @error('shoes_size') is-invalid @enderror" name="shoes_size" value="{{ old('shoes_size') }}">
                @error('shoes_size')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control @error('height') is-invalid @enderror" name="height" value="{{ old('height') }}">
                @error('height')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control @error('glasses') is-invalid @enderror" name="glasses" value="{{ old('glasses') }}">
                @error('glasses')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
...
<div class="modal fade text-left" id="modal-additional-{{ $additional->id }}">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Edit Employee - Edit Additional Data</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
