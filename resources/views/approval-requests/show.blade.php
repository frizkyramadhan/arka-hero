                ...
                <div class="col-lg-8">
                    @if ($approvalPlan->document_type === 'officialtravel')
                        ...
                        <div class="document-card document-info-card">
                            ...
                            <div class="card-body">
                                @php $document = App\Models\Officialtravel::with(['traveler.employee', 'traveler.position.department', 'traveler.project', 'transportation', 'accommodation', 'stops', 'details.follower.employee', 'details.follower.position.department', 'details.follower.project'])->find($approvalPlan->document_id); @endphp

                                <!-- Travel Details -->
                                @include('officialtravels.partials.travel-details-info-grid', [
                                    'officialtravel' => $document,
                                ])
                            </div>
                        </div>
                    ...
                    @elseif($approvalPlan->document_type === 'flight_request')
                        ...
                        <div class="flight-request-card flight-details-card">
                            ...
                            <div class="card-body">
                                @include('flight-requests.partials.flight-details-segments', [
                                    'flightRequest' => $document,
                                ])
                            </div>
                        </div>
