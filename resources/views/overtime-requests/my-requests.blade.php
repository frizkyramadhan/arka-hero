...
@section('title', $title ?? 'My Overtime Requests')
...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">{{ $title ?? 'My Overtime Requests' }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('/') }}">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('dashboard.personal') }}">My Dashboard</a></li>
                        <li class="breadcrumb-item active">{{ $title ?? 'My Overtime Requests' }}</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div id="accordion">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">{{ $title ?? 'My Overtime Requests' }}</h3>
                                <div class="card-tools">
                                    @can('personal.overtime.create-own')
                                        <a href="{{ route('overtime.my-requests.create') }}" class="btn btn-warning">
                            ...
                            <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="filter_employee_q"
                                                            name="employee_q" placeholder="NIK or employee name"
                                                            autocomplete="off">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="filter_remarks_q"
                                                            name="remarks_q" placeholder="Text in remarks"
                                                            autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="table-responsive">
                                    <table id="overtime-my-requests-table" class="table table-bordered table-striped"
                                        width="100%">
                                        <thead>
                                            <tr>
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#overtime-my-requests-table').DataTable({
                ...
                dom: 'rtip',
                ajax: {
                    url: "{{ route('overtime.my-requests.data') }}",
                    data: function(d) {
            ...
            $('#filter_employee_q, #filter_remarks_q').on('keyup', function() {
            ...
            $('#btn-reset-filter').on('click', function() {
                ...
                $('#filter_employee_q, #filter_remarks_q').val('');
                table.draw();
            });
        });
    </script>
