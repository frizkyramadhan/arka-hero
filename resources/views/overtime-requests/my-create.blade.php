                                                ...
                                                <tr class="line-row" data-index="{{ $idx }}">
                                                    <td>
                                                        <select name="details[{{ $idx }}][administration_id]"
                                                            class="form-control form-control-sm line-admin select2bs4"
                                                    ...
                                                    <td>
                                                        <input type="time" name="details[{{ $idx }}][time_out]"
                                                            class="form-control form-control-sm"
        ...
        (function() {
            ...
            $('#btn-add-line').on('click', function() {
                ...
                tr.innerHTML =
                    ...
                    '][administration_id]" class="form-control form-control-sm line-admin select2bs4" style="width:100%;" required><option value="">— Select employee —</option></select></td>' +
                    '<td><input type="time" name="details[' + lineIndex +
                    '][time_in]" class="form-control form-control-sm" required></td>' +
                    '<td><input type="time" name="details[' + lineIndex +
                    '][time_out]" class="form-control form-control-sm" required></td>' +
                    '<td><input type="text" name="details[' + lineIndex +
                    '][work_description]" class="form-control form-control-sm" placeholder="Description"></td>' +
