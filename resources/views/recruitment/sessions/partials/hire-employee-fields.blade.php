...
@if ($showRegisterCheckbox)
    <div class="form-group">
        <div class="custom-control custom-checkbox">
            <input type="checkbox" class="custom-control-input hire-register-employee-toggle"
                id="register_to_employee" name="register_to_employee" value="1"
                {{ old('register_to_employee') ? 'checked' : '' }}>
            <label class="custom-control-label" for="register_to_employee">
                Register to Employee Management
            </label>
        </div>
        <small class="form-text text-muted">Optional. When enabled, register a new employee or link an existing employee from Employee Management.</small>
    </div>
@endif
<div id="hire_employee_sections{{ $suffix }}" class="hire-employee-sections {{ ($showRegisterCheckbox && !old('register_to_employee')) ? 'd-none' : '' }}">
    <div class="form-group mb-3">
        ...
        <div class="custom-control custom-radio custom-control-inline">
            ...
            <label class="custom-control-label" for="registration_mode_existing{{ $suffix }}">Existing Employee</label>
        </div>
        <small class="form-text text-muted">New: create employee with personal and administration data. Existing: link an employee already in the system — their current administration data is used as-is.</small>
    ...
    <div id="existing_employee_panel{{ $suffix }}" class="existing-employee-panel {{ $registrationMode === 'existing' ? '' : 'd-none' }}">
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <small class="form-text text-muted">Search by fullname, NIK, or identity card number.</small>
                </div>
    ...
    <div id="new_employee_panel{{ $suffix }}" class="new-employee-panel {{ $registrationMode === 'existing' ? 'd-none' : '' }}">
                    <div class="card mb-3">
    ...
    <div id="administration_panel{{ $suffix }}" class="administration-panel {{ $registrationMode === 'existing' ? 'd-none' : '' }}">
                    <div class="card">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select
                                                ...
                                                name="administration[position_id]" id="hire_position_id_magang_harian{{ $suffix }}"
                                                data-required-when-register required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select
                                                class="form-control @error('administration.position_id') is-invalid @enderror"
                                                name="administration[position_id]" id="hire_position_id{{ $suffix }}" data-required-when-register required>
                                                <option value="">Select position</option>
                                                @foreach (\App\Models\Position::orderBy('position_name', 'asc')->get() as $position)
                                                    <option value="{{ $position->id }}"
                                                        {{ old('administration.position_id', optional($session->fptk)->position_id) == $position->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Department</label>
                                            <input type="text" class="form-control" id="hire_department{{ $suffix }}" readonly>
                                            <small class="form-text text-muted">Department will be automatically filled
                                                based on position selection</small>
                                        </div>
                                    </div>
