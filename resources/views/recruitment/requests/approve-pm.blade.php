        ...
        <div class="fptk-content">
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="fptk-card acknowledgment-status-card">
                        <div class="card-head">
                            <h2><i class="fas fa-user-check"></i> HR Acknowledgment Status</h2>
                        </div>
                        <div class="card-body">
                            <div class="status-grid">
                                ...
                                @if ($fptk->known_at)
                                    <div class="status-item">
                                        ...
                                        <div class="status-content">
                                            <div class="status-label">Acknowledgment Date</div>
                ...
                <div class="col-lg-4">
                    <div class="fptk-card approval-card">
                        <div class="card-head">
                            <h2><i class="fas fa-user-shield"></i> PM Approval Decision</h2>
                        </div>
                        <div class="card-body">
                            <!-- Decision Buttons -->
                            ...
                            <!-- PM Approval Form -->
                            <form action="{{ route('recruitment.requests.approve-pm', $fptk->id) }}" method="POST"
                                id="pmApprovalForm">
                                @csrf
                                <input type="hidden" name="pm_approval_status" id="pm_approval_status" value="">

                                <div class="form-group">
                                    <label for="pm_approval_remark">PM Approval Notes <span
                                            class="text-danger">*</span></label>
                                    <textarea class="form-control @error('pm_approval_remark') is-invalid @enderror" name="pm_approval_remark"
                                        id="pm_approval_remark" rows="4"
                                        placeholder="Please provide your approval details:
• Decision rationale
• Any conditions or requirements
• Additional notes or observations"
                                        required>{{ old('pm_approval_remark') }}</textarea>
                                    @error('pm_approval_remark')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>

                                <div class="form-actions">
                                    <button type="submit" class="btn btn-warning btn-block submit-btn" disabled>
...
@section('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const statusInput = document.getElementById('pm_approval_status');
            const submitBtn = document.querySelector('.submit-btn');
            const remarkTextarea = document.getElementById('pm_approval_remark');
            ...
            document.getElementById('pmApprovalForm').addEventListener('submit', function(e) {
                ...
                if (!remarkTextarea.value.trim()) {
                    e.preventDefault();
                    alert('Please provide PM approval notes.');
                    return;
                }

                const status = statusInput.value;
                const confirmMessage = status === 'approved' ?
                    'Are you sure you want to approve this FPTK as Project Manager?' :
                    'Are you sure you want to reject this FPTK as Project Manager?';
