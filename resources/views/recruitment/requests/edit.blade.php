            ...
            <form action="{{ route('recruitment.requests.update', $fptk->id) }}" method="POST" id="fptkForm">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <!-- Letter Number Selection Card (HR konfirmasi) -->
                        <div class="card card-info card-outline elevation-2">
                            ...
                            <div class="card-body py-2">
                                @include('components.smart-letter-number-selector', [
                                    'categoryCode' => 'FPTK',
                                    'required' => false,
                                    'selectedValue' => old('letter_number_id', $fptk->letter_number_id),
                                ])
                                <small class="form-text text-muted mt-1">
                                    <i class="fas fa-info-circle"></i>
                                    Pilih nomor surat untuk konfirmasi/assign ke FPTK ini. FPTK number akan diupdate sesuai
                                    pilihan.
                                </small>
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text"
                                                    class="form-control {{ $fptk->letter_number_id ? 'alert-success' : 'alert-warning' }}"
                                                    id="fptk_number" value="{{ $fptk->request_number }}"
                                                    placeholder="{{ $fptk->letter_number_id ? '' : 'Pilih Letter Number untuk generate FPTK Number' }}"
                                                    readonly>
                                            </div>
                                            <small class="form-text text-muted">
                                                <i class="fas fa-info-circle"></i>
                                                @if ($fptk->letter_number_id)
                                                    Nomor FPTK saat ini. Ubah dengan memilih Letter Number di atas.
                                                @else
                                                    Pilih Letter Number di atas untuk generate FPTK number.
                                                @endif
                                            </small>
                                        </div>
                                    </div>
