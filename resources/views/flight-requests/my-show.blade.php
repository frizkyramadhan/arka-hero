...
@section('title', $title ?? 'My Flight Request Details')
                    ...
                    <div class="flight-request-card employee-card">
                        ...
                        <div class="card-body">
                            @php
                                ...
                                $poh = $administration && isset($administration->poh) ? $administration->poh : 'N/A';
                                $doh =
                    ...
                    <div class="flight-request-card actions-card">
                        ...
                        <div class="card-body">
                            <div class="actions-list">
                                <a href="{{ route('flight-requests.my-requests') }}" class="btn-action back-btn">
...
@section('styles')
    <style>
        ...
        /* LOT followers — match official travel detail */
        .followers-card {
            overflow: hidden;
        }
