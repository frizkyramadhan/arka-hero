                ...
                <table id="example1" width="100%" class="table table-sm table-bordered table-striped">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center">Health Insurance No</th>
                      <th class="text-center">Health Facility</th>
                      <th class="text-center">Insurance Remarks</th>
  ...
  $(function() {
    var table = $("#example1").DataTable({
      ...
      , columns: [{
        ...
        , orderable: false
      , }, {
        data: "health_insurance_type"
        , name: "health_insurance_type"
        , orderable: false
      , }, {
        data: "health_insurance_no"
