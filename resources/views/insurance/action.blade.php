<a class="btn btn-icon btn-primary btn-xs" href="{{ url('insurances/' . $insurances->id . '/show') }}" data-toggle="modal" data-target="#modal-lg-{{ $insurances->id }}"><i class="fas fa fa-eye"></i></a>
