...
@section('content')
    @php
        $selectedFollowers = old('followers', $officialtravel->details->pluck('follower_id')->toArray());
    @endphp
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a
                                href="{{ route('officialtravels.my-travels.show', $officialtravel->id) }}">{{ $officialtravel->official_travel_number }}</a>
                        </li>
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="{{ route('officialtravels.my-travels.update', $officialtravel->id) }}" method="POST"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <small class="form-text text-muted">Nomor pengajuan (tidak dapat
                                                diubah).</small>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date" id="official_travel_date_picker"
                                                ...
                                                <input type="date"
                                                    ...
                                                    value="{{ old('official_travel_date', $officialtravel->official_travel_date?->format('Y-m-d')) }}" />
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="main-traveler-position">
                                                {{ $myAdministration->position->position_name ?? '-' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="main-traveler-project">
                                                {{ $myAdministration->project->project_name ?? '-' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('purpose') is-invalid @enderror" name="purpose" id="purpose" rows="3"
                                        placeholder="Enter Purpose of Travel">{{ old('purpose', $officialtravel->purpose) }}</textarea>
                                    @error('purpose')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date" id="departure_from_picker"
                                                ...
                                                <input type="date"
                                                    ...
                                                    name="departure_from"
                                                    value="{{ old('departure_from', $officialtravel->departure_from?->format('Y-m-d')) }}" />
                                        ...
                                        <tbody>
                                            @foreach ($selectedFollowers as $followerId)
                                                @php
                                                    ...
                                                    $followerData = collect($employees)->firstWhere('id', $followerId);
                                                @endphp
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card elevation-3">
                            <div class="card-body">
                                ...
                                <a href="{{ route('officialtravels.my-travels.show', $officialtravel->id) }}"
