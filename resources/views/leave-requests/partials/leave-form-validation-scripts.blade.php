            ...
            $('form.js-leave-request-form').on('submit', function(e) {
                ...
                const usageMode = String($('#lsl_usage_mode').val() || '');
                ...
                if (!lslVisible || usageMode !== 'cashout_only') {
                ...
                if (!totalDays || totalDays <= 0) {
                    messages.push('Total days must be greater than 0. Please select a date range or enter total days.');
                }
