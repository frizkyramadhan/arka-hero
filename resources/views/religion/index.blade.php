  ...
  <div class="modal fade" id="modal-lg">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form class="form-horizontal" action="{{ url('religions') }}" method="POST">
            ...
            <div class="card-body">
              <div class="tab-content p-0">
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control @error('religion_name') is-invalid @enderror" name="religion_name" value="{{ old('religion_name') }}" placeholder="Religion Name" required>
                    @error('religion_name')
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <select name="religion_status" class="form-control @error('religion_status') is-invalid @enderror">
                      <option value="1" {{ old('religion_status') == '1' ? 'selected' : '' }}>
                        Active</option>
                      <option value="0" {{ old('religion_status') == '0' ? 'selected' : '' }}>Inactive
                      </option>
                    </select>
