<a class="btn btn-icon btn-primary btn-xs" href="{{ url('educations/' . $educations->id . '/show') }}" data-toggle="modal" data-target="#modal-lg-{{ $educations->id }}"><i class="fas fa fa-eye"></i></a>
