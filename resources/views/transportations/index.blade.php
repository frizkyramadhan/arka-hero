        ...
        <div class="modal fade" id="modal-lg">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="{{ url('transportations') }}" method="POST">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text"
                                                ...
                                                name="transportation_name" value="{{ old('transportation_name') }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="transportation_status"
                                                ...
                                                <option value="1"
                                                    {{ old('transportation_status') == '1' ? 'selected' : '' }}>Active
                                                </option>
                                                <option value="0"
                                                    {{ old('transportation_status') == '0' ? 'selected' : '' }}>Inactive
                                                </option>
                                            </select>
    ...
    <script>
        $(function() {
            var table = $("#example1").DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('transportations.data') }}",
                    data: function(d) {
        ...
        // Function to handle edit transportation
