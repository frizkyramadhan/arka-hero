                ...
                <table id="example1" width="100%" class="table table-sm table-bordered table-striped">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center">Emergency Call Relation</th>
                      <th class="text-center">Emergency Call Phone</th>
                      <th class="text-center">Emergency Call Address</th>
  ...
  $(function() {
    var table = $("#example1").DataTable({
      ...
      , }, {
        ...
        , orderable: false
      , }, {
        data: "emrg_call_relation"
        , name: "emrg_call_relation"
        , orderable: false
        , className: "text-center"
      , }, {
        data: "emrg_call_phone"
        , name: "emrg_call_phone"
        , orderable: false
        , searchable: false
        , className: "text-center"
      , }, {
        data: "emrg_call_address"
        , name: "emrg_call_address"
        , orderable: false
        , searchable: false
        , className: "text-center"
      , }, {
