        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Position Data Table</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                ...
                <div class="col-sm-12 col-md-6">
                  ...
                  <div class="col-sm-12 col-md-6">
                    <div class="mt-5 d-flex justify-content-end">
                      <a href="{{route('addPost')}}" class="btn btn-primary btn-sm">Add Data</a>
                  </div>
                  </div>
                </div>
                <div class="my-3">
           ...
           {{-- {{$positions}} --}}
                ...
                <tr role="row">
                  ...
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Rendering engine: activate to sort column ascending">Position Name</th>
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Department Name</th>              
                ...
                <tbody>
                  @foreach ($positions as $item)
                    <tr class="odd">
                      ...
                      <td class="sorting_1">{{ $item->departments->department_name }}</td>
                      <td class="text-center">
                        <form action="deletePost/{{$item->slug}}" method="post"
                          ...
                          <a href="editPost/{{$item->slug}}" class="btn btn-primary btn-sm">
