...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-8">
                    <form action="{{ route('employee-bonds.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Create Employee Bond</h3>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="employee_bond_number" id="employee_bond_number"
                                            class="form-control alert-warning @error('employee_bond_number') is-invalid @enderror"
                                            value="{{ old('employee_bond_number', '[Letter Number]/ARKA-HCS/' . \Carbon\Carbon::now()->format('M') . '/' . now()->year) }}"
                                            placeholder="Select Letter Number to Generate Bond Number" readonly>
                                    ...
                                    <small class="form-text text-muted">
                                        ...
                                        Bond number will be auto-generated when you select a letter number above
                                    </small>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror"
                                        rows="3" placeholder="Describe the bond details...">{{ old('description') }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" name="total_investment_value"
                                                    ...
                                                    value="{{ old('total_investment_value') }}" min="0"
                                                    step="0.01" required>
                                            </div>
                                            <small class="form-text text-info">
                                                <i class="fas fa-info-circle"></i> Duration will be calculated automatically
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="total_bond_duration_months"
                                                ...
                                                value="{{ old('total_bond_duration_months') }}" min="1" readonly>
                                            <small class="form-text text-muted">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="document" id="document"
                                                ...
                                                accept=".pdf,.doc,.docx">
                                            <small class="form-text text-muted">Upload bond agreement document (PDF, DOC,
                                                DOCX)</small>
                                            @error('document')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
            ...
            <div class="col-lg-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div id="bond-info">
                            <p class="text-muted">Fill in the form to see bond information</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                if (startDate && endDate && duration && investment) {
                                ...
                                <thead class="bg-light">
                                    <tr>
                                        <th colspan="2" class="text-center">
                                            <i class="fas fa-handshake"></i> Bond Information
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="badge badge-primary">${duration} months</span></td>
                                    </tr>
                                    <tr>
                    ...
                    bondInfoDiv.innerHTML = `
                        <div class="alert alert-info">
                            <i class="fas fa-info-circle"></i> Fill in the form to see bond information
                        </div>
                    `;
                }
            }
