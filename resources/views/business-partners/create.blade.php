...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Create Business Partner</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('business-partners.index') }}">Business Partners</a>
                        </li>
    ...
    <section class="content">
        <div class="container-fluid">
            <form method="POST" action="{{ route('business-partners.store') }}" id="businessPartnerForm">
                @csrf
                <div class="row">
                    <!-- Left Column -->
                    <div class="col-md-8">
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="bp_code" id="bp_code"
                                                    ...
                                                    value="{{ old('bp_code') }}" placeholder="Enter Business Partner Code"
                                                    required>
                                                @error('bp_code')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="bp_name" id="bp_name"
                                                    ...
                                                    value="{{ old('bp_name') }}" placeholder="Enter Business Partner Name"
                                                    required>
                                                @error('bp_name')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea name="bp_address" id="bp_address" class="form-control @error('bp_address') is-invalid @enderror"
                                            rows="3" placeholder="Enter complete address">{{ old('bp_address') }}</textarea>
                                        @error('bp_address')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="bp_phone" id="bp_phone"
                                                    ...
                                                    value="{{ old('bp_phone') }}" placeholder="e.g., +62 21 1234 5678">
                                                @error('bp_phone')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                        ...
                        <div class="card card-info card-outline elevation-3">
                            ...
                            <div class="card-body">
                                <div class="callout callout-info">
                                    ...
                                    <p>
                                        <strong>BP Code:</strong> Use a unique, short code for easy identification (e.g.,
                                        "BP001", "GARUDA", "CITILINK").
                                    </p>
                                    <p>
                                        <strong>Status:</strong> Only active business partners will be available for
                                        selection when creating flight issuances.
                                    </p>
                                    <p>
                                        <strong>Contact Info:</strong> Ensure phone number and address are accurate for
