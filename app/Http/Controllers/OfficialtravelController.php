...
class OfficialtravelController extends Controller
{
    ...
    //             'status' => $request->approval_status == 'approved' ? 'open' : 'draft',
    //         ]);
