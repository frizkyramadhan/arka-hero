...
class LeaveRequestSummaryResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'display_start_date' => $this->displayStartDate('Y-m-d'),
            'display_end_date' => $this->displayEndDate('Y-m-d'),
            'display_total_days' => $this->displayTotalDaysLabel(),
            'is_lsl_cashout_only' => $this->isLSLCashoutOnly(),
