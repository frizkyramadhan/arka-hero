...
-   `[done] P1: FOA No format FOA-{project_code}-{sequence} (letter number unchanged) [VehicleAssignment::formatFormNumber, foa-form-scripts, widen form_number] (completed: 2026-09-21)`
